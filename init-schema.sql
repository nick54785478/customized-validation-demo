...
(6, 'ROW', 'DEPT_PROFILE', 'HR', 'NAME', 'ENFORCE_ROW_VALIDATION', '#checkedValue!=\'\'', '\'SheetName : \' + #sheetName + \', \'  + #excelAddress + \" 資料檢核有誤，不能為空\"', 5, 'Y'),
(7, 'ROW', 'DEPT_PROFILE', 'HR', 'AGE', 'ENFORCE_ROW_VALIDATION', '#isNumeric(#checkedValue) && #checkedValue!=\'\' && #checkedValue.matches(\'^[1-9]\\d*$\')', '\'SheetName : \' + #sheetName + \', \'  + #excelAddress + \" 資料檢核有誤，不能為空或需為整數\"', 6, 'Y'),
(8, 'ROW', 'DEPT_PROFILE', 'HR', 'SEX', 'ENFORCE_ROW_VALIDATION', '#checkedValue!=\'\'', '\'SheetName : \' + #sheetName + \', \'  + #excelAddress + \" 資料檢核有誤，不能為空\"', 7, 'Y'),
(9, 'ROW', 'DEPT_PROFILE', 'HR', 'NATION_ID', 'ENFORCE_ROW_VALIDATION', '#checkedValue!=\'\' &&  #checkedValue.matches(\'^[A-Z][12]\\d{8}$\')', '\'SheetName : \' + #sheetName + \', \'  + #excelAddress + \" 資料檢核有誤，不能為空或身分證字號格式有誤 \"', 8, 'Y'),
(10, 'ROW', 'USER_PROFILE', 'USER', 'NAME', 'ENFORCE_ROW_VALIDATION', '#checkedValue!=\'\'', '\'SheetName : \' + #sheetName + \', \'  + #excelAddress + \" 資料檢核有誤，不能為空 \"', 9, 'Y'),
(11, 'ROW', 'USER_PROFILE', 'USER', 'AGE', 'ENFORCE_ROW_VALIDATION', '#isNumeric(#checkedValue) && #checkedValue!=\'\' && #checkedValue.matches(\'^[1-9]\\d*$\')', '\'SheetName : \' + #sheetName + \', \'  + #excelAddress + \" 資料檢核有誤，不能為空或需為整數 \"', 10, 'Y'),
(12, 'ROW', 'USER_PROFILE', 'USER', 'SEX', 'ENFORCE_ROW_VALIDATION', '#checkedValue!=\'\'', '\'SheetName : \' + #sheetName + \', \'  + #excelAddress + \" 資料檢核有誤，不能為空 \"', 11, 'Y'),
(13, 'ROW', 'USER_PROFILE', 'USER', 'NATION_ID', 'ENFORCE_ROW_VALIDATION', '#checkedValue!=\'\' &&  #checkedValue.matches(\'^[A-Z][12]\\d{8}$\')', '\'SheetName : \' + #sheetName + \', \'  + #excelAddress + \" 資料檢核有誤，不能為空或身分證字號格式有誤  \"', 12, 'Y'),
(14, 'SHEET', 'USER_PROFILE', 'USER', 'NATION_ID', '', '#validateDuplicate(#sheet, \'NATION_ID\')', '', 13, 'Y');
